        ...
        <div class="hy_list">
        	<div class="box_t">
                ...
                <div class="position">
                    ...
                    <span><img src=<?php echo APP_IMAGE_PATH."icon3.png"; ?> alt=""/></span>
                    <a href="?c=Admin&a=list_credit_adopt">已认定列表</a>
                </div>
                <!--当前位置-->
            </div>
			...
			<!--查询-->
            <div class="search">
				<form action="?c=Admin&a=search_credit_adopt" method="post" id="search_form">
            	<span>按学号查询：</span>
...
?>
                <a href="?c=Admin&a=list_credit_adopt" class="btn">刷新</a>
