        ...
        <div class="hy_list">
            ...
            <table cellpadding="0" cellspacing="0" class="list_hy">
              <tr>
                ...
                <th scope="col"><div>名称</div></th>
                <th class="zt" scope="col"><div>简介</div></th>
                <th scope="col">类型</th>
                <th scope="col">标准学分</th>
                <th scope="col">日期</th>
                <th scope="col">地点</th>
                <th scope="col">标准人数</th>
...
?>
		<tr>
            ...
            <td><?php echo $act['actual_people_number']; ?></td>
...
?>
            ...
            <div class="r_foot">
                ...
                <!--分页-->
                <div class="page">
                	<a href="?c=Admin&a=list_activity&p=<?php echo $item[page]<3?1:$item[page]-1; ?>" class="prev">
						<img src=<?php echo APP_IMAGE_PATH."icon7.png"; ?> alt=""/>
					</a>
<?php
	$total_page = floor(($item['act_num']-1) / 10 + 1);
