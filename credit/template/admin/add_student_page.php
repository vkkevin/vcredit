...
<div id="right_ctn">
	<div class="right_m">
        	...
        	<div class="box_t">
				<span class="name">添加学生</span><!--当前位置-->
				<div class="position">
                    ...
                    <span><img src=<?php echo APP_IMAGE_PATH."icon3.png"; ?> alt=""/></span>
                    <a href="?c=Admin&a=add_student">添加学生</a>
				</div>
            </div>


            <form action="?c=Admin&a=add_student_exec" method="post" id="student_form">
              <ul class="hypz">
                    <li class="clearfix"><span class="title">姓名：</span>
                      <div class="li_r">
                            <input  name="stuInfo[name]" type="text">
                        </div>
                    </li>
                    <li class="clearfix"><span class="title">学号：</span>
                      <div class="li_r">
                            <input  name="stuInfo[id]" type="text">
                        </div>
                    </li>
					<li class="clearfix"><span class="title">性别：</span>
                      	<div class="li_r input_radio">
                            <input name="stuInfo[sex]" type="radio" value="man" checked="checked">男
                            <input name="stuInfo[sex]" type="radio" value="woman">女
                        </div>
                    </li>
                    <li class="clearfix"><span class="title">院系：</span>
                      <div class="li_r">
                            <input  name="stuInfo[department]" type="text">
                            &nbsp;</div>
                    </li>
                     <li class="clearfix"><span class="title">专业：</span>
                       <div class="li_r">
                            <input  name="stuInfo[specialty]" type="text">
                            &nbsp;</div>
                    </li>
                     <li class="clearfix"><span class="title">班级：</span>
                       <div class="li_r">
                            <input  name="stuInfo[class]" type="text">
                            &nbsp;</div>
                    </li>
                     <li class="clearfix"><span class="title">辅导员：</span>
                       <div class="li_r">
                            <input  name="stuInfo[instructor]" type="text">
                            &nbsp;</div>
                    </li>
                     <li class="clearfix"><span class="title">备注：</span>
                       <div class="li_r">
                            <input  name="stuInfo[remark]" type="text">
						</div>
                    </li>


                    <p align="right"><li class="tj_btn"><a href="#" onclick="add_student()">保存</a></li></p>
                </ul>
