        ...
        <div class="hy_list">
        	<div class="box_t">
                ...
                <div class="position">
                    ...
                    <span><img src=<?php echo APP_IMAGE_PATH."icon3.png"; ?> alt=""/></span>
                    <a href="?c=Admin&a=list_credit_veto">否决列表</a>
                </div>
                <!--当前位置-->
            </div>
			...
			<!--查询-->
            <div class="search">
				<form action="?c=Admin&a=search_credit_veto" method="post" id="search_form">
            	<span>按学号查询：</span>
				...
				<span>按<select name="where[s_condition]">
					...
					<option value="cogizant_id">操作者</option>
				</select>查询：</span>
...
?>
			<td><?php echo $cdt['cogizant_id']; ?></td>
			<td>
				<a href="?c=Admin&a=show_credit&id=<?php echo $cdt['id'] ?>" class="btn">查看</a>
<?php
		if($item['role'] == 'svip'){
?>
				<a href="?c=Admin&a=del_credit&id=<?php echo $cdt['id'] ?>" class="btn">删除</a>
<?php
		}
?>
			</td>
...
?>
                <a href="?c=Admin&a=list_credit_veto" class="btn">刷新</a>
