...
{_url:'网址',  error:'出错代码, 成为时为0,非0表示出错',message:'出错提示信息, 为空时出错不提示', width:'宽度',height:'高度'}

*/
$result=array();
$result['_url']='http://'.$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME'].'/../../face/'.rand(1,50).'.gif';//time().'.jpg';//上传数据网址
